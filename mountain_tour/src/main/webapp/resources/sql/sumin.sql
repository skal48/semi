...
INSERT INTO MAGAZINE_T (MAGAZINE_NO, USER_NO, TITLE, CONTENTS, CREATE_AT, PRODUCT_NO) VALUES(MAGAZINE_SEQ.NEXTVAL, 1, '설악산', '떠나요 설악산', TO_DATE(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), 1);
INSERT INTO MAGAZINE_T (MAGAZINE_NO, USER_NO, TITLE, CONTENTS, CREATE_AT, PRODUCT_NO) VALUES(MAGAZINE_SEQ.NEXTVAL, 2, '설악산', '떠나요 설악산', TO_DATE(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), 1);
INSERT INTO MAGAZINE_T (MAGAZINE_NO, USER_NO, TITLE, CONTENTS, CREATE_AT, PRODUCT_NO) VALUES(MAGAZINE_SEQ.NEXTVAL, 1, '설악산', '떠나요 설악산', TO_DATE(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), 2);

INSERT INTO MAGAZINE_MULTI_T VALUES(4, 'MAGAZINE/PICTURE/', 'ABC.JPG');
INSERT INTO MAGAZINE_MULTI_T VALUES(5, 'MAGAZINE/PICTURE/', 'ABC1.JPG');
INSERT INTO MAGAZINE_MULTI_T VALUES(6, 'MAGAZINE/PICTURE/', 'ABC2.JPG');

INSERT INTO MAGAZINE_STAR_T VALUES(4, 1);
INSERT INTO MAGAZINE_STAR_T VALUES(5, 1);
INSERT INTO MAGAZINE_STAR_T VALUES(6, 2);

SELECT M.TITLE, MM.FILESYS_NAME
  FROM MAGAZINE_T M RIGHT OUTER JOIN MAGAZINE_MULTI_T MM
    ON M.MAGAZINE_NO = MM.MAGAZINE_NO
  WHERE M.MAGAZINE_NO = 5;   