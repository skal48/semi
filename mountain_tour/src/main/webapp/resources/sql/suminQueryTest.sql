...
SELECT M.TITLE, MM.FILESYS_NAME, M.SUMMARY
 ...
 WHERE M.MAGAZINE_NO BETWEEN ((SELECT MAX(MAGAZINE_NO) FROM MAGAZINE_T) - 2) AND ((SELECT MAX(MAGAZINE_NO) FROM MAGAZINE_T)- 1)
...
INSERT INTO MAGAZINE_T(MAGAZINE_NO, USER_NO, TITLE, CONTNETS, CREATE_AT, PRODUCT_NO;   
