...
-- 예약 등록
INSERT INTO RESERVE_T VALUES(RESERVE_SEQ.NEXTVAL, TO_DATE('20231004', 'YYYYMMDD'), '예약하기 어렵다', 0, '서울역', 0, TO_DATE('20231004', 'YYYYMMDD'),  3, 1, 1);
INSERT INTO RESERVE_T VALUES(RESERVE_SEQ.NEXTVAL, TO_DATE('20231004', 'YYYYMMDD'), '이건 요구사항입니다', 0, '동대문', 0, TO_DATE('20231004', 'YYYYMMDD'), 2, 1, 1);
...
-- 리뷰 등록
INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 1, 1, 3, '또 가고싶어요. 이런 상품 많이 만들어 주세요~', TO_DATE(SYSDATE, 'YYYY-MM-DD'), TO_DATE(SYSDATE, 'YYYY-MM-DD'), '미삭제', 5); 
INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 1, 2, 3, '재밌었어요. 가이드 설명도 알차요~', TO_DATE(SYSDATE, 'YYYY-MM-DD'), TO_DATE(SYSDATE, 'YYYY-MM-DD'), '미삭제', 5); 
INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 2, 3, 5, '힘둘다..', TO_DATE(SYSDATE, 'YYYY-MM-DD'), TO_DATE(SYSDATE, 'YYYY-MM-DD'), '미삭제', 4); 
INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 2, 4, 3, '추억은 방울방울', TO_DATE(SYSDATE, 'YYYY-MM-DD'), TO_DATE(SYSDATE, 'YYYY-MM-DD'), '미삭제', 5); 
INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 3, 5, 4, '엥 짱나~', TO_DATE(SYSDATE, 'YYYY-MM-DD'), TO_DATE(SYSDATE, 'YYYY-MM-DD'), '삭제', 3); 
INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 4, 6, 6, '아주 좋은 경험이었습니다.', TO_DATE(SYSDATE, 'YYYY-MM-DD'), TO_DATE(SYSDATE, 'YYYY-MM-DD'), '미삭제', 5); 
INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 2, 5, 5, '멋지..네요..', TO_DATE(SYSDATE, 'YYYY-MM-DD'), TO_DATE(SYSDATE, 'YYYY-MM-DD'), '미삭제', 4); 
COMMIT;
...
SELECT REVIEW_NO, PRODUCT_NO, RESERVE_NO, USER_NO, CONTENTS, CREATED_AT, MODIFIED_AT, STATUS, STAR
  FROM (SELECT ROW_NUMBER() OVER(ORDER BY PRODUCT_NO DESC) AS RN, REVIEW_NO, PRODUCT_NO, RESERVE_NO, USER_NO, CONTENTS, CREATED_AT, MODIFIED_AT, STATUS, STAR
          FROM REVIEW_T)
 WHERE RN BETWEEN 1 AND 10;
