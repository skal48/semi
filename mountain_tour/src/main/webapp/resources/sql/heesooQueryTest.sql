...
-- 리뷰 등록
INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 1, 1, '또 가고싶어요. 이런 상품 많이 만들어 주세요~', TO_DATE(SYSDATE, 'YYYY-MM-DD'), TO_DATE(SYSDATE, 'YYYY-MM-DD'), 5); 
INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 1, 2, '재밌었어요. 가이드 설명도 알차요~', TO_DATE(SYSDATE, 'YYYY-MM-DD'), TO_DATE(SYSDATE, 'YYYY-MM-DD'), 5); 
INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 2, 3, '힘둘다..', TO_DATE(SYSDATE, 'YYYY-MM-DD'), TO_DATE(SYSDATE, 'YYYY-MM-DD'), 4); 
INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 2, 4, '추억은 방울방울', TO_DATE(SYSDATE, 'YYYY-MM-DD'), TO_DATE(SYSDATE, 'YYYY-MM-DD'), 5); 
INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 3, 5, '엥 짱나~', TO_DATE(SYSDATE, 'YYYY-MM-DD'), TO_DATE(SYSDATE, 'YYYY-MM-DD'), 3); 
INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 4, 3, '아주 좋은 경험이었습니다.', TO_DATE(SYSDATE, 'YYYY-MM-DD'), TO_DATE(SYSDATE, 'YYYY-MM-DD'), 5); 
INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 2, 5, '멋지..네요..', TO_DATE(SYSDATE, 'YYYY-MM-DD'), TO_DATE(SYSDATE, 'YYYY-MM-DD'), 4); 
INSERT INTO REVIEW_T VALUES(REVIEW_SEQ.NEXTVAL, 2, 5, '우와아아ㅏㅏ아아악 긴댓글긴댓글긴댓글 우와아아ㅏㅏ아아악 긴댓글긴댓글긴댓글 우와아아ㅏㅏ아아악 긴댓글긴댓글긴댓글 우와아아ㅏㅏ아아악 긴댓글긴댓글긴댓글', TO_DATE(SYSDATE, 'YYYY-MM-DD'), TO_DATE(SYSDATE, 'YYYY-MM-DD'), 4); 
COMMIT;
