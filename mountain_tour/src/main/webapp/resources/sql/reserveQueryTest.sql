...
CREATE TABLE MAGAZINE_MULTI_T (
	MAGAZINE_NO	 NUMBER	       NOT NULL,  -- 매거진 번호
	MULTI_PATH	 VARCHAR2(100) NULL,      -- 멀티미디어 경로
	FILESYS_NAME VARCHAR2(100) NULL,      -- 파일 이름
...
-- 문의 등록
INSERT INTO INQUIRY_T VALUES(INQUIRY_SEQ.NEXTVAL, 3, 1, '환불해주세요', '저 다른데 갈래요', NULL, 0, TO_DATE('20231004', 'YYYYMMDD'));
INSERT INTO INQUIRY_T VALUES(INQUIRY_SEQ.NEXTVAL, 4, 1, '이게모에요', '어떻게 예약하나요?', NULL, 0, TO_DATE('20231004', 'YYYYMMDD'));
COMMIT;

-- 문의 답변 등록
INSERT INTO INQUIRY_ANSWER_T VALUES(ANSWER_SEQ.NEXTVAL, 1, 1, '환불해드렸습니다.', '속히 새로운 상품으로 찾아뵙겠습니다.', 0, TO_DATE('20231004', 'YYYYMMDD'),TO_DATE('20231004', 'YYYYMMDD'));
INSERT INTO INQUIRY_ANSWER_T VALUES(ANSWER_SEQ.NEXTVAL, 2, 2, '안녕하세요. 함께하는 산행 춘하추동 여행사입니다.', '상품 상세페이지에서 예약 가능합니다. 감사합니다.', 0, TO_DATE('20231004', 'YYYYMMDD'),TO_DATE('20231004', 'YYYYMMDD'));
COMMIT;
...
INSERT INTO RESERVE_T VALUES(RESERVE_SEQ.NEXTVAL, TO_DATE('20231004', 'YYYYMMDD'), '저는 유저4입니다', 0, '가산디지털', 0, TO_DATE('20231004', 'YYYYMMDD'), TO_DATE('20231004', 'YYYYMMDD'), 2, 1, 4);
COMMIT;
...
SELECT T.TOURIST_NO, T.NAME, T.BIRTH_DATE, T.GENDER, T.CONTACT, T.AGE_CASE, T.RESERVE_NO, RES.RESERVE_START, RES.RESERVE_FINISH, RES.PRODUCT_NO
  FROM TOURIST_T T RIGHT OUTER JOIN RESERVE_T RES
    ON T.RESERVE_NO = RES.RESERVE_NO
 WHERE RES.RESERVE_NO = 1;
