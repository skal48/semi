...
<jsp:include page="../layout/header.jsp">
  ...
  <div class="row">
	...
	<form id="frm_agree" action="${contextPath}/user/join.form">
		...
		<button type="button" class="btn btn-primary" onclick="checkAgreements()">동의하기</button>
		...
		<div>
			<input type="checkbox" name="service" id="service_company" class="chk_each">
			<label for="service" class="text text-danger"><h5>서비스 이용약관 동의(필수)</h5></label>
			</div>
			<div>
				 <textarea id="myTextarea" oninput="autoResizeTextarea()">제1조(목적) 이 약관은 업체 회사(전자상거래 사업자)가 운영하는 업체 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
...
제24조(재판권 및 준거법)
  ...
  ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
			...
			<div class="gap-2 mb-3">
				<input type="checkbox" name="service" id="service_person" class="chk_each">
				<label for="service" class="text text-danger"><h5>개인정보 수집 및 이용 동의(필수)</h5></label>
				<div>
					<textarea>개인정보처리방침
