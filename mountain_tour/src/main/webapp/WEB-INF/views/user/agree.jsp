	...
	<div>
		...
		<script>
			function checkAgreements(){
				var termsCheckbox = document.getElementById("service_company");
				var privacyCheckbox = document.getElementById("service_person");
				
				if(termsCheckbox.checked && privacyCheckbox.checked){
					document.getElementById("frm_agree").submit();
				} else {
					alert("서비스 약관과 개인정보 처리 방침에 모두 동의해야 합니다.")
				}
			}
		</script>
...
<!-- 서비스 이용약관 동의(필수) -->
	<div style="text-align:left;">
		<input type="checkbox" name="service" id="service_company" class="form-check-input chk_each" checked>
		<label for="service_company" class="form-check-label text-danger">서비스 이용약관 동의(필수)</label>
		</div>
		
		<div>
			 <textarea rows="5" class="form_service form-control">제1조(목적) 이 약관은 업체 회사(전자상거래 사업자)가 운영하는 업체 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
...
② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
 ...
 <!-- 개인정보 수집 및 이용동의(필수) -->		
    <div class="form-check mt-3" style="text-align:left;">
      <input type="checkbox" name="event" class="form-check-input chk_each" id="service_personal" checked>
      <label class="form-check-label text-danger" for="service_personal">개인정보 수집 및 이용동의(필수)</label>
	</div>
				
		<div>
		 <textarea rows="5" class="form_personal form-control">[차례]
1. 총칙
2. 개인정보 수집에 대한 동의
3. 개인정보의 수집 및 이용목적
4. 수집하는 개인정보 항목
...
15. 부 칙(시행일)
현 개인정보처리방침은 2023년 11월 16일에 제정되었으며, 정부 및 회사의 정책 또는 보안기술의 변경에 따라 내용의 추가, 삭제 및 수정이 있을 경우에는 개정 최소 7일 전부터 ‘공지사항’란을 통해 고지하며, 본 정책은 시행 일자에 시행됩니다.
1) 공고일자 : 2023년 11월 16일
2) 시행일자 : 2023년 11월 16일</textarea>
		</div>
    ...
    <div class="form-check mt-3" style="text-align:left;">
      ...
      <label class="form-check-label" for="event">이벤트 알림 동의(선택)</label>
	</div>
	
	 <div>
      <textarea rows="5" class="form-control">주식회사 마운틴투어(이하 “회사”)가 운영하는 머스타드(MUST-AD)서비스에서 개인정보보호법 및 정보통신망 이용촉진 정보보호 등에 관한 법률 등 관계법령에 따라 광고성 정보를 전송하기 위해 이용자의 사전 수신 동의를 받고 있습니다. 개인정보보호법 제22조 제5항에 의해 선택정보 사항에 대해서는 기재하지 않아도 서비스를 이용하실 수 있습니다.
...
수신 동의 이후에도 의사에 따라 동의를 철회할 수 있으며, 수신을 동의하지 않아도 회사에서 제공하는 기본적인 서비스를 이용할 수 있으나 회사가 제공하는 마케팅 정보를 수신하지 못할 수 있습니다. 고객이 본 수신 동의를 철회하고자 할 경우 앱내 알림 설정 또는 고객센터를 통하여 수신 동의 철회를 요청할 수 있습니다. 또한 향후 마케팅정보 수신에 새롭게 동의하고자 할 경우 앱내 알림 설정에서 동의하실 수 있습니다.

- 시행일자: 2023년 11월 16일</textarea>
    </div>
	...
	<button type="submit" class="btn btn-success" onclick="checkAgreements()">동의하기</button>
