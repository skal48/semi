...
<div class="wrap wrap_6">
  ...
  <form id="frm_naver_join" method="post" action="${contextPath}/user/naver/join.do">
    ...
    <div>
      <textarea rows="5" class="form-control">제1조(목적) 이 약관은 업체 회사(전자상거래 사업자)가 운영하는 업체 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
...
​주식회사 마운틴투어(이하 “회사”)가 운영하는 머스타드(MUST-AD)서비스에서 개인정보보호법 및 정보통신망 이용촉진 정보보호 등에 관한 법률 등 관계법령에 따라 광고성 정보를 전송하기 위해 이용자의 사전 수신 동의를 받고 있습니다. 개인정보보호법 제22조 제5항에 의해 선택정보 사항에 대해서는 기재하지 않아도 서비스를 이용하실 수 있습니다. 
